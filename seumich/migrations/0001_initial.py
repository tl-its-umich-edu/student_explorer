# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2016-04-29 01:38


from django.utils import timezone
from django.db import migrations, models
import django.db.models.deletion
import seumich.mixins
import seumich.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', seumich.models.UsernameField(db_column=b'ADVSR_UM_UNQNM', max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', seumich.models.UsernameField(db_column=b'MNTR_UM_UNQNM', max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.IntegerField(db_column=b'ACAD_PERF_ORDNL_NBR', null=True)),
            ],
            options={
                'ordering': ('order',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', seumich.models.UsernameField(db_column=b'STDNT_UM_UNQNM', max_length=16)),
            ...
            bases=(models.Model, seumich.mixins.SeumichDataMixin),
        ),
        migrations.CreateModel(
            name='Term',
            fields=[
        ...
        migrations.CreateModel(
            name='ClassSiteScore',
            fields=[
                ('class_site', models.ForeignKey(db_column=b'CLASS_SITE_KEY', on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='seumich.ClassSite')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('student', models.ForeignKey(db_column=b'STDNT_KEY', on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='seumich.Student')),
                ('advisor', models.ForeignKey(db_column=b'ADVSR_KEY', on_delete=django.db.models.deletion.CASCADE, to='seumich.Advisor')),
                ('role', models.ForeignKey(db_column=b'ADVSR_ROLE_KEY', on_delete=django.db.models.deletion.CASCADE, to='seumich.AdvisorRole')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_due_date', models.ForeignKey(db_column=b'ASSGN_DUE_SBMT_DT_KEY', null=True, on_delete=django.db.models.deletion.CASCADE, to='seumich.Date')),
            ],
            options={
                'ordering': ('_due_date',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('week_end_date', models.ForeignKey(db_column=b'WEEK_END_DT_KEY', on_delete=django.db.models.deletion.CASCADE, to='seumich.Date')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extrct_dt', models.DateTimeField(default=timezone.now, db_column=b'EXTRCT_DT')),
                ('load_dt', models.DateTimeField(default=timezone.now, db_column=b'LOAD_DT')),
        ...
        migrations.AddField(
            ...
            name='source_system',
            field=models.ForeignKey(db_column=b'SRC_SYS_KEY', null=True, on_delete=django.db.models.deletion.CASCADE, to='seumich.SourceSystem'),
        ),
        migrations.AddField(
            model_name='cohort',
            name='source_system',
        ...
        migrations.AddField(
            ...
            name='class_site',
            field=models.ForeignKey(db_column=b'CLASS_SITE_KEY', on_delete=django.db.models.deletion.CASCADE, to='seumich.ClassSite'),
        ),
        migrations.AddField(
            model_name='classsiteterm',
            name='term',
            field=models.ForeignKey(db_column=b'TERM_KEY', on_delete=django.db.models.deletion.CASCADE, to='seumich.Term'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='classsite',
            name='terms',
            field=models.ManyToManyField(through='seumich.ClassSiteTerm', to='seumich.Term'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='weeklystudentclasssitestatus',
            name='status',
            field=models.ForeignKey(db_column=b'ACAD_PERF_KEY', on_delete=django.db.models.deletion.CASCADE, to='seumich.Status'),
        ),
        migrations.AddField(
            model_name='weeklystudentclasssitestatus',
            name='week_end_date',
            field=models.ForeignKey(db_column=b'WEEK_END_DT_KEY', on_delete=django.db.models.deletion.CASCADE, to='seumich.Date'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='weeklystudentclasssiteevent',
            name='event_type',
            field=models.ForeignKey(db_column=b'EVENT_TYP_KEY', on_delete=django.db.models.deletion.CASCADE, to='seumich.EventType'),
        ),
        migrations.AddField(
            model_name='weeklystudentclasssiteevent',
            name='week_end_date',
        ...
        migrations.AddField(
            ...
            name='cohort',
            field=models.ForeignKey(db_column=b'CHRT_KEY', on_delete=django.db.models.deletion.CASCADE, to='seumich.Cohort'),
        ),
        migrations.AddField(
            model_name='studentcohortmentor',
            name='mentor',
            field=models.ForeignKey(db_column=b'MNTR_KEY', on_delete=django.db.models.deletion.CASCADE, to='seumich.Mentor'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='assignment',
            field=models.ForeignKey(db_column=b'ASSGN_KEY', on_delete=django.db.models.deletion.CASCADE, to='seumich.Assignment'),
        ),
        migrations.AddField(
            model_name='studentclasssiteassignment',
            name='class_site',
        ...
        migrations.AddField(
            model_name='student',
            name='class_sites',
            field=models.ManyToManyField(through='seumich.StudentClassSiteStatus', to='seumich.ClassSite'),
        ),
        migrations.AddField(
            model_name='student',
            name='cohorts',
            field=models.ManyToManyField(through='seumich.StudentCohortMentor', to='seumich.Cohort'),
        ),
        migrations.AddField(
            model_name='student',
            name='mentors',
            field=models.ManyToManyField(through='seumich.StudentCohortMentor', to='seumich.Mentor'),
        ),
        migrations.AddField(
            model_name='student',
            name='statuses',
            field=models.ManyToManyField(through='seumich.StudentClassSiteStatus', to='seumich.Status'),
        ),
        migrations.AddField(
            model_name='mentor',
            name='students',
            field=models.ManyToManyField(through='seumich.StudentCohortMentor', to='seumich.Student'),
        ),
        migrations.AddField(
            model_name='advisor',
            name='students',
            field=models.ManyToManyField(through='seumich.StudentAdvisorRole', to='seumich.Student'),
        ),
